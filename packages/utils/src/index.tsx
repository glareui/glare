...
import { RenderProvider, useRenderState } from "./contexts";
...
const getDefaultFormProps = (type: ComponentType) => {
  ...
  const componentDefaultProps =
    renderContext.chakra.components[type].defaultProps;
  return {
    ...componentDefaultProps,
    ...renderContext.chakra.DEFAULT_FORM_PROPS[type],
  };
};

const chakraRenderConfig = {
  components: Chakra,
  DEFAULT_FORM_PROPS: DEFAULT_FORM_PROPS,
};

export { RenderProvider, getDefaultFormProps, chakraRenderConfig };
